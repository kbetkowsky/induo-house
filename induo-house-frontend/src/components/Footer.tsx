  ...
  return (
    ...
    >
          ...
          <div className="footer-brand">
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              {[
                ...
                <a key={index} href={social.href} className="footer-social" aria-label="Social link">
                  {social.icon}
                </a>
              ))}
            </div>
      ...
      <div style={{ borderTop: '1px solid var(--footer-border)', padding: '14px 24px' }}>
        ...
        >
          <p style={{ fontSize: 12, color: 'var(--text-faint)', margin: 0 }}>© {year} InduoHouse. Wszelkie prawa zastrzeżone.</p>
          <p style={{ fontSize: 12, color: 'var(--text-faint)', margin: 0 }}>Zbudowano z pasją w Polsce</p>
        </div>
      </div>
    </footer>
  );
