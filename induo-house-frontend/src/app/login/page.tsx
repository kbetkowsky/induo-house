...
export default function LoginPage() {
  ...
  const inputStyle = (name: string, hasError?: boolean): React.CSSProperties => ({
    ...
    borderRadius: 14,
    border: `1.5px solid ${
      hasError ? 'rgba(239,68,68,0.6)' : focusedField === name ? 'rgba(59,130,246,0.6)' : 'rgba(255,255,255,0.09)'
    }`,
    background: focusedField === name ? 'rgba(37,99,235,0.06)' : 'rgba(255,255,255,0.04)',
    color: '#e2e8f0',
    fontSize: 15,
    fontFamily: 'inherit',
    outline: 'none',
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'grid', gridTemplateColumns: '1fr 1fr' }} className="auth-grid">
          ...
          <div style={{ maxWidth: 340 }}>
            ...
            <div style={{ display: 'flex', gap: 12 }}>
              {[
                ...
                >
                  <div style={{ fontSize: 20, fontWeight: 900, color: '#60a5fa', letterSpacing: '-0.02em' }}>{value}</div>
                  <div style={{ fontSize: 11, color: '#475569', marginTop: 3, fontWeight: 600 }}>{label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="auth-right" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 48px', background: '#080b14' }}>
        <div style={{ width: '100%', maxWidth: 440 }}>
          ...
          <div style={{ marginBottom: 36 }}>
            <h1 style={{ fontSize: 30, fontWeight: 900, color: '#f1f5f9', margin: '0 0 8px', letterSpacing: '-0.03em' }}>Zaloguj się</h1>
          ...
          >
            <form onSubmit={handleSubmit((data) => login(data))} autoComplete="off" style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
              <div>
                ...
                {errors.email && <p style={{ margin: '7px 0 0', fontSize: 12, color: '#f87171' }}>{errors.email.message}</p>}
              </div>
              ...
              <div>
                ...
                {errors.password ? (
                  ...
                  <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 8, fontSize: 12, color: '#64748b' }}>
                    Reset hasła dodam w kolejnej wersji.
                  </div>
                )}
              </div>
